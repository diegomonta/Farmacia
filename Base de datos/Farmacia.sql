...
CREATE PROCEDURE ListarPedidoPorEstadoMedicamento
@MedicamentoCodigo INT,
@MedicamentoFarmaceutica VARCHAR(13),
@Estado VARCHAR(50)
AS BEGIN
...
--LISTAR PEDIDO
CREATE PROCEDURE ListarPedidoMedicamento
@MedicamentoCodigo INT,
@MedicamentoFarmaceutica VARCHAR(13)
AS BEGIN
	SELECT * FROM Pedido 
...
--PEDIDOS DATA DE PRUEBA
--PEDIDOS ANDRES
EXEC AltaPedido 'ANDRES',0,'3213213213213',5,'GENERADO'
GO
EXEC AltaPedido 'ANDRES',0,'2342342342342',2,'ENVIADO'
GO
EXEC AltaPedido 'ANDRES',2,'1231231231231',6,'GENERADO'
GO

--PEDIDOS AGUSTIN
EXEC AltaPedido 'AGUSTIN',0,'3213213213213',5,'GENERADO'
GO
EXEC AltaPedido 'AGUSTIN',3,'2342342342342',1,'ENTREGADO'
GO
EXEC AltaPedido 'AGUSTIN',2,'3213213213213',3,'ENTREGADO'
GO

--PEDIDOS SOLEDAD
EXEC AltaPedido 'SOLEDAD',0,'2342342342342',2,'GENERADO'
GO
